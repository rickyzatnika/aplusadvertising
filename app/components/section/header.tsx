...
const Header = () => {
  return (
    <div className='w-full h-full flex flex-col md:flex-row items-center justify-center gap-2 py-8 md:py-16 relative'>
      {/* <div className='absolute bottom-0 left-0 w-full h-full -z-10 bg-gradient-to-tr from-[#000000] to-transparent ' /> */}
      <div className=' flex flex-col py-3 gap-4 w-full md:w-[50%] '>
