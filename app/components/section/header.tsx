  ...
  return (
    <div className='w-full h-full flex flex-col md:flex-row items-center justify-center gap-2 py-8 md:py-16 px-4 md:px-24 lg:px-32 relative'>
      ...
      <div className=' flex flex-col  gap-4 w-full md:w-[50%] '>
        <h1 className='text-white text-3xl md:text-5xl lg:text-7xl leading-tight'>Transforming Ideas Into Impactful <span className='font-extrabold text-[#f7a619]'>Advertising</span> Solutions</h1>
